                                    ...
                                    const setSubTotalOnCredit = (e)=>{
                                        ...
                                        if (Number.isInteger(val) && val > 0) {
                                            ...
                                            if (totalTickets.upToNumber === 0) {
                                                ...
                                                let setSubTotal = val * (totalTickets.upToNumber+1);
                                    ...
                                    const setSubTotalOnPrice = (e)=>{
                                        ...
                                        if (val && val > 0) {
                                            ...
                                            if (rangeTickets ==='' && qty_credits_per_ticket === '' && startRaffleBasket === '') {
                                                ...
                                                let setSubTotal = parseInt(qty_credits_per_ticket) * parseInt(totalTickets.upToNumber+1);
                                              
                                                let customRaffle = 0;
                                                let percentageStart = percentage_start;
                                                

                                                let ticketSold = totalTickets;
                                                if (startRaffleBasket === '1') {
                                                    customRaffle = setSubTotal;
                                                    // setSubTotal = setSubTotal;
                                                    percentageStart = '';
                                                    ticketSold = totalTickets.upToNumber+1;
                                                }
                                                if (startRaffleBasket === '2' || startRaffleBasket ==='') {
                                                    customRaffle = val+resultMath;
                                                    percentageStart = percentage_start || 70;
                                                    ticketSold = parseInt(customRaffle) / parseInt(qty_credits_per_ticket);
                                                }
                                                ...
                                                setValues({
                                                    ...values,
                                                    sub_total:setSubTotal,
                                                    totalPersentage:customRaffle,
                                                    percentage_start:percentageStart,
                                                    ...
                                                    <section className="row">
                                                        ...
                                                        {buyinFormatContent === '1' &&
                                                            <div className="col-12">
                                                                ...
                                                                <div className="col-12">
                                                                        <div className="form-group">
                                                                            <label htmlFor="rangeTickets">Range tickts<sup>*</sup></label>
                                                                            <Field 
                                                                                component="select" 
                                                                                id='rangeTickets' 
                                                                                name="rangeTickets" 
